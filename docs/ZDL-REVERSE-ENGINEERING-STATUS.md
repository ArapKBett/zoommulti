...
* Does the current ToTape9 page-granular read-only parameter fallback plus
  cached critical controls stop first-touch Bias/Output and zero-output startup
  issues without fighting saved pedal values?
