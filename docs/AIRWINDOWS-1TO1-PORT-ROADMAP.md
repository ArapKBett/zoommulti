...
1. Verify the page-granular read-only parameter fallback plus critical-control
   cache and document whether first-touch Bias/Output and zero-output startup
   are fixed.
